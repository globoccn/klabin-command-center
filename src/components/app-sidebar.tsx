...
export function AppSidebar() {
  ...
  return (
    <aside className="app-sidebar-command relative sticky left-0 top-0 z-40 hidden h-screen w-[188px] shrink-0 flex-col overflow-hidden border-r border-sidebar-border bg-sidebar lg:flex">
      <div className="sidebar-client-brand relative z-10 shrink-0 px-7 pb-4 pt-6">
      ...
      <nav
        className="sidebar-navigation relative z-10 min-h-0 flex-1 space-y-2 overflow-y-auto px-3 pb-3 pt-2"
      ...
      <footer className="sidebar-footer">
        <div className="sidebar-notes-stack">
...
function SidebarNote({ icon: Icon, text }: { icon: typeof Leaf; text: string }) {
  return (
    <div className="sidebar-note rounded-[12px] border border-primary/24 bg-[linear-gradient(140deg,rgba(5,46,35,.86),rgba(3,25,23,.92))] px-3 py-2.5 shadow-[0_8px_20px_rgba(0,0,0,.22)] backdrop-blur-sm">
