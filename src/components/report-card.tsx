  ...
  return (
    <article className="command-card group relative flex min-h-[220px] flex-col p-4 transition duration-200 hover:-translate-y-0.5 hover:border-primary/34">
      ...
      <div className="mt-auto flex gap-2 pt-4">
        <Button size="sm" onClick={() => onView(report)} className="h-8 flex-1 bg-primary text-[10px] text-primary-foreground hover:bg-primary-glow" disabled={!ready}><Eye className="mr-1 h-3.5 w-3.5" /> Visualizar</Button>
