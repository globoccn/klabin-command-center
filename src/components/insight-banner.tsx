...
export function InsightBanner() {
  return (
    <section className="mt-3 min-h-[64px] overflow-hidden rounded-[13px] border border-primary/38 bg-[linear-gradient(100deg,rgba(5,57,38,.72),rgba(4,28,25,.9)_48%,rgba(4,42,31,.76))] px-4 py-2.5 shadow-[0_12px_30px_rgba(0,0,0,.2),inset_0_1px_0_rgba(255,255,255,.025)]">
      <div className="grid min-h-[42px] grid-cols-[minmax(300px,1.65fr)_repeat(3,minmax(110px,.55fr))_190px] items-center gap-3">
